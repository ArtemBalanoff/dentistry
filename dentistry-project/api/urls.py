...
from appointments.views import avaliable_days, avaliable_timeslots
...
urlpatterns = [
    ...
    path('v1/get-avaliable-days', avaliable_days),
    path('v1/get-avaliable-timeslots', avaliable_timeslots),
]
